  ...
  <div style="font-family:Helvetica,Arial,sans-serif;background:#06070D;padding:24px">
    <div style="max-width:560px;margin:0 auto;background:#0B0D17;border-radius:16px;overflow:hidden;border:1px solid #1F2440">
      <div style="background:#0B0D17;padding:18px 24px;border-bottom:1px solid #1F2440">
        <span style="display:inline-block;vertical-align:middle;width:34px;height:34px;border-radius:9px;background:linear-gradient(135deg,#6E76FF,#A06AFF);color:#FFFFFF;font-size:19px;font-weight:800;text-align:center;line-height:34px">W</span>
        <span style="display:inline-block;vertical-align:middle;margin-left:10px;color:#FFFFFF;font-size:18px;font-weight:800">Webryx Sites</span>
      </div>
...
export function clientEmail(n) {
  return {
    subject: "We've received your website enquiry — Webryx Sites",
    html: shell(
