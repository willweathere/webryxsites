      ...
      <div className="relative mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
        ...
        {PROCESS_STEPS.map((s, i) => (
          <div key={s.n} style={{ "--i": i }}
            className="stagger-item group relative flex flex-col rounded-3xl border border-white/10 bg-white/[0.03] p-6 transition-all duration-200 hover:-translate-y-1 hover:border-brand-400/40 hover:shadow-card-lift">
            <span className="relative flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-brand-500 to-iris-500 font-display text-base font-bold text-white shadow-glow-brand transition-transform duration-300 group-hover:scale-105">
              {s.n}
            </span>
